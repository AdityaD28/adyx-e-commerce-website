  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url("/images/accessoriescollection.jpg")'
        }}
      >
        <div className="text-center text-white">
          <h1 className="text-5xl font-bold mb-4 drop-shadow-lg">Accessories Collection</h1>
          <p className="text-xl drop-shadow-md font-light">Complete your perfect look</p>
        </div>
      </div>
