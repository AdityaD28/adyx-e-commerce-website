    ...
    <footer className="bg-gray-50 border-t border-gray-200" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-12 lg:py-16">
            ...
            <div className="max-w-md">
              ...
              <form className="mt-4 flex flex-col sm:flex-row">
                ...
                <div className="mt-3 sm:ml-3 sm:mt-0 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="flex w-full items-center justify-center rounded-md border border-transparent bg-black px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  >
                    Subscribe
                  </button>
                </div>
          ...
          {/* Bottom section */}
          <div className="mt-8 border-t border-gray-200 pt-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
